...
public static class SimplexNoise {
    public static double[] Calc1D(int width, double scale) {
        ...
        for (var i = 0; i < width; i++)
            values[i] = (Generate(i * scale) * 128 + 128) * 0.00392156862745;
        return values;
    }
    ...
    public static double[,] Calc2D(int width, int height, double scale) {
        ...
        for (var i = 0; i < width; i++)
            for (var j = 0; j < height; j++)
                values[i, j] = (Generate(i * scale, j * scale) * 128 + 128) * 0.00392156862745;
        return values;
    }
        ...
        for (var i = 0; i < width; i++)
            for (var j = 0; j < height; j++)
                for (var k = 0; k < length; k++)
                    values[i, j, k] = (Generate(i * scale, j * scale, k * scale) * 128 + 128) * 0.00392156862745;
        return values;
    }

    public static double CalcPixel1D(int x, double scale) {
        return (Generate(x * scale) * 128 + 128) * 0.00392156862745;
    }

    public static double CalcPixel2D(int x, int y, double scale) {
        return (Generate(x * scale, y * scale) * 128 + 128) * 0.00392156862745;
    }

    public static double CalcPixel3D(int x, int y, int z, double scale) {
        return (Generate(x * scale, y * scale, z * scale) * 128 + 128) * 0.00392156862745;
    }
